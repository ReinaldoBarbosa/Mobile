...
public class ListaOngAdapter extends RecyclerView.Adapter<ListaOngAdapter.OngViewHolder> {
    private List<UsuarioModel> listaOng; // Renomeado para OngModel
    private Fragment context;

    public ListaOngAdapter(Fragment context, List<UsuarioModel> listaOng) { // Renomeado para OngModel
    ...
    public OngViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lista_ong, parent, false); // Supondo que você tenha um layout para a ONG
